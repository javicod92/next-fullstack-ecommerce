    ...
    <div className="bg-bgGray">
      ...
      >
        ...
        <nav className="flex flex-col gap-2">
          ...
          <Link
            href="/products"
            className={router.includes("/products") ? activeLink : inactiveLink}
            onClick={() => setShowSidebar(false)}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              stroke="currentColor"
              className={
                router.includes("/products") ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
          ...
          <Link
            href="/categories"
            className={
              router.includes("/categories") ? activeLink : inactiveLink
            }
            onClick={() => setShowSidebar(false)}
          >
            <svg
          ...
          <Link
            href="/orders"
            className={router.includes("/orders") ? activeLink : inactiveLink}
            onClick={() => setShowSidebar(false)}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <Link
            href="/settings"
            className={router.includes("/settings") ? activeLink : inactiveLink}
            onClick={() => setShowSidebar(false)}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              stroke="currentColor"
              className={
                router.includes("/settings") ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
