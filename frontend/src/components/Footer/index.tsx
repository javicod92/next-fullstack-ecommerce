...
export default function Footer() {
  return (
    <div className="py-10 px-4 md:px-8 lg:px-16 xl:32 2xl:px-64 bg-gray-100 text-sm mt-20">
      {/* TOP SECTION */}
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          ...
          <p>
            3252 Winding Way, Central Plaza, Willowbrook, CP 3500, Resistencia
            Chaco, Argentina
          </p>
